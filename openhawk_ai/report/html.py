...
from openhawk_ai.report.helpers import html_escape
from openhawk_ai.utils.time import convert_time_for_display
from openhawk_ai.ai.formatter import render_ai_analysis_html_rich
...
def render_html_content(
    ...
    *,
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                <div class="header-watermark">OpenHawk</div>
    ...
    html += """
            ...
            <div class="footer">
                <div class="footer-content">
                    由 <span class="project-name">OpenHawk</span> 生成 ·
                    <a href="https://github.com/sansan0/OpenHawk" target="_blank" class="footer-link">
                        GitHub 开源项目
                    </a>"""
    ...
    html += """
        ...
        <script>
            ...
            function toggleWideMode() {
                ...
                try { localStorage.setItem('openhawk_ai-wide-mode', isWide ? '1' : '0'); } catch(e) {}
            ...
            function toggleDarkMode() {
                ...
                try { localStorage.setItem('openhawk_ai-dark-mode', isDark ? '1' : '0'); } catch(e) {}
            ...
            async function saveAsImage() {
                ...
                try {
                    ...
                    const now = new Date();
                    const filename = `OpenHawk_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}.png`;
            ...
            async function saveAsMultipleImages() {
                ...
                try {
                    ...
                    // 下载所有图片
                    const now = new Date();
                    const baseFilename = `OpenHawk_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}`;
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // 自动检测宽屏模式
                var savedMode = null;
                try { savedMode = localStorage.getItem('openhawk_ai-wide-mode'); } catch(e) {}
                ...
                // 暗色模式恢复
                var savedDark = null;
                try { savedDark = localStorage.getItem('openhawk_ai-dark-mode'); } catch(e) {}
                if (savedDark === '1') {
