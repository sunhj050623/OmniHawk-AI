...
-- ============================================
-- 新闻条目表
-- 以 URL + platform_id 作为唯一标识，支持去重存储
-- ============================================
CREATE TABLE IF NOT EXISTS news_items (
    ...
    last_crawl_time TEXT NOT NULL,       -- 最近抓取时间
...
-- ============================================
-- 时间段执行记录表
-- 用于 once 逻辑：记录每天每个 period 在 analyze/push 上是否已执行
-- ============================================
CREATE TABLE IF NOT EXISTS period_executions (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    execution_date TEXT NOT NULL,          -- YYYY-MM-DD
    period_key TEXT NOT NULL,              -- period 稳定 key
...
-- URL + platform_id 唯一索引（仅对非空 URL，防重复）
