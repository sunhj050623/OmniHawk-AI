...
from openhawk_ai.core.frequency import matches_word_groups, _word_matches
...
def count_rss_frequency(
    ...
    """
    from openhawk_ai.utils.time import format_iso_time_friendly
        ...
        for group in word_groups:
            ...
            if matched:
                ...
                title_data = {
                    ...
                    "paper_insight": item.get("paper_insight", {}) or {},
                }
