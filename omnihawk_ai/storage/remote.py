...
from omnihawk_ai.storage.base import StorageBackend, NewsData, RSSItem, RSSData
...
class RemoteStorageBackend(SQLiteStorageMixin, StorageBackend):
    ...
    def __init__(
        ...
        # 创建临时目录
        self.temp_dir = Path(temp_dir) if temp_dir else Path(tempfile.mkdtemp(prefix="omnihawk_ai_"))
