...
class RSSItem:
    ...
    count: int = 1                      # 抓取次数
    paper_meta: Dict[str, Any] = field(default_factory=dict)     # 论文元信息
    paper_insight: Dict[str, Any] = field(default_factory=dict)  # 论文洞察
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "paper_insight": self.paper_insight,
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "RSSItem":
        ...
        return cls(
            ...
            paper_insight=data.get("paper_insight", {}) or {},
        )
