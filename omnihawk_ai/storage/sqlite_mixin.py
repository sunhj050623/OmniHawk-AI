...
from omnihawk_ai.storage.base import NewsItem, NewsData, RSSItem, RSSData
from omnihawk_ai.utils.url import normalize_url
                            ...
                            if existing:
                                ...
                                cursor.execute("""
                                    ...
                                    ON CONFLICT(url, feed_id) DO UPDATE SET
                                        ...
                                        paper_insight_json = excluded.paper_insight_json,
